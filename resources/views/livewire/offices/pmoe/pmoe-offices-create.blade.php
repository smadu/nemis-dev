<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Create Provincial Ministry of Education Office') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Create Provincial Ministry of Education Office profile and account') }}
        </flux:subheading>
        ...
        <form wire:submit.prevent="save" class="mt-6 max-w-xl space-y-6">
            ...
            <div class="flex flex-col space-y-4">
                    ...
                    <!-- workplaceId Code -->
                        <flux:field>
                            <flux:input label="Work Place ID" wire:model.live="workplaceId"
                                placeholder="PMOE000001" mask="PMOE999999"/>
                        </flux:field>
                ...
                <div class="flex flex-col gap-4">
                    <flux:field>
                        <flux:input label="Provincial Ministry of Education Name" id="pmoeName" type="text" wire:model.live="pmoeName" placeholder="Provincial Ministry of Education Name"/>
                    </flux:field>
                </div>
