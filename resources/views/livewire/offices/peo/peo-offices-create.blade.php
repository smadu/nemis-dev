<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Create Provincial Education Office') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Create Provincial Education Office profile and account') }}
        </flux:subheading>
        ...
        <form wire:submit.prevent="save" class="mt-6 max-w-xl space-y-6">
            ...
            <div class="flex flex-col space-y-4">
                    ...
                    <!-- workplaceId Code -->
                        <flux:field>
                            <flux:input label="Work Place ID" wire:model.live="workplaceId"
                                placeholder="PE00000001" mask="PE99999999"/>
                        </flux:field>
                ...
                <div class="flex flex-col">
                    <flux:field>
                        <flux:select label="Provincial Education Ministry" id="provincialMinistry" wire:model.live="provincialMinistry">
                            <option value="">{{ __ ('Select Provincial Education Ministry') }}</option>
                ...
                <div class="flex flex-col gap-4">
                    <flux:field>
                        <flux:input label="Provincial Education Office Name" id="peoName" type="text" wire:model.live="peoName" placeholder="Provincial Education Office Name"/>
                    </flux:field>
                </div>
