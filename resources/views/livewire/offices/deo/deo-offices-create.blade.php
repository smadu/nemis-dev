<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Create Divisional Education Office') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Create Divisional Education Office profile and account') }}
        </flux:subheading>
        ...
        <form wire:submit.prevent="save" class="mt-6 max-w-xl space-y-6">
            ...
            <div class="flex flex-col space-y-4">
                    ...
                    <!-- workplaceId Code -->
                        <flux:field>
                            <flux:input label="Work Place ID" wire:model.live="workplaceId"
                                placeholder="DE00000001" mask="DE99999999"/>
                        </flux:field>
                ...
                <div class="flex flex-col gap-4">
                    <flux:field>
                        <flux:input label="Divisional Education Office Name" id="deoName" type="text" wire:model.live="deoName" placeholder="Institution Name"/>
                    </flux:field>
                </div>
