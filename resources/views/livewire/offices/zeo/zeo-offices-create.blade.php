<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Create Zonal Education Office') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Create Zonal Education Office profile and account') }}
        </flux:subheading>
        ...
        <form wire:submit.prevent="save" class="mt-6 max-w-xl space-y-6">
            ...
            <div class="flex flex-col space-y-4">
                    ...
                    <!-- workplaceId Code -->
                        <flux:field>
                            <flux:input label="Work Place ID" wire:model.live="workplaceId"
                                placeholder="ZE00000001" mask="ZE99999999"/>
                        </flux:field>
                ...
                <div class="flex flex-col gap-4">
                    <flux:field>
                        <flux:input label="Zonal Education Office Name" id="zeoName" type="text" wire:model.live="zeoName" placeholder="Zonal Education Office Name"/>
                    </flux:field>
                </div>
